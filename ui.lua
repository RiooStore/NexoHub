-- [[ NEXO HUB - PREMIUM UI ONLY FILE ]]
local TweenService = game:GetService("TweenService")
local UserInputService = game:GetService("UserInputService")
local RunService = game:GetService("RunService")
local CoreGui = game:GetService("CoreGui")

-- Ambil nama game dari global, jika belum load beri nama default
...
local function CreateFeatureRow(text, btnText, callback)
    ...
    ActionBtn.MouseButton1Click:Connect(function() 
        ...
        task.wait(0.05)
        ActionBtn.Size = UDim2.new(0, 95, 0, 30)
        -- Menjalankan callback jika file core sudah ter-loadstring sempurna
...
-- =======================================================
-- [[ STRUCTURING CONTENT & LINKING TO FILE 1 ]]
-- =======================================================
local T1 = CreateTab("ⓘ", "Info")
local T2 = CreateTab("⚙", "Settings")
local T3 = CreateTab("⚓", "Farm")
local T4 = CreateTab("⚡", "Automatic")
local T5 = CreateTab("💬", "Webhook")
local T6 = CreateTab("🛠", "Utilities")

local Cat1 = CreateCategory("Movement")

-- PENTING: Tombol di bawah memanggil fungsi dari _G.NexoHub_Features yang ada di File 1
local R1, L1, B1, S1 = CreateFeatureRow("WalkSpeed", "Set 100", function() 
    if _G.NexoHub_Features then _G.NexoHub_Features.SetWalkSpeed(100) end 
end)
local R2, L2, B2, S2 = CreateFeatureRow("JumpPower", "Set 120", function() 
    if _G.NexoHub_Features then _G.NexoHub_Features.SetJumpPower(120) end 
end)
local R3, L3, B3, S3 = CreateFeatureRow("Reset Speed & Jump", "Reset", function() 
    if _G.NexoHub_Features then _G.NexoHub_Features.ResetStats() end 
end)

local Cat2 = CreateCategory("Modes")
local R4, L4, B4, S4 = CreateFeatureRow("Infinite Jump", "Enable", function() 
    if _G.NexoHub_Features then _G.NexoHub_Features.EnableInfJump() end 
end)

-- =======================================================
-- [[ DRAG & ENGINE CORE CONTROL ]]
-- =======================================================
